package com.zte.topsky.irrigate.customui;
...
public class IrrigateColumnDiagramView extends BaseChartView implements Runnable{
    ...
    private List<CustomLineData> mCustomLineDataset = new ArrayList<>();
    ...
    private ArrayList<PieData> chartDataPie = new ArrayList<>();


    public IrrigateColumnDiagramView(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        initView();
    }

    public IrrigateColumnDiagramView(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
    }

    public IrrigateColumnDiagramView(Context context, AttributeSet attrs, int defStyle) {
...
//        chartPieRender();
    ...
    private void chartRender()
    {
        try {
            ...
            //轴标题
            chart.getAxisTitle().setLeftTitle("水量（吨）");
//            chart.getAxisTitle().setLowerTitle("分布位置");
    ...
    private void chartDataSet()
    {
        ...
        dataSeriesA.add(228d);
        dataSeriesA.add(126d);
        BarData BarDataA = new BarData("1号机井",dataSeriesA,colorORACLE);


        List<Double> dataSeriesB= new ArrayList<>();
        dataSeriesB.add(272d);
        dataSeriesB.add(374d);
        BarData BarDataB = new BarData("2号机井",dataSeriesB,colorMSSQL);
//
//        List<Double> dataSeriesC= new ArrayList<>();
//        dataSeriesC.add(79d);
//        dataSeriesC.add(91d);
//        dataSeriesC.add(65d);
//        BarData BarDataC = new BarData("MySQL",dataSeriesC,colorMYSQL);
//
//        List<Double> dataSeriesD= new ArrayList<>();
//        dataSeriesD.add(52d);
//        dataSeriesD.add(45d);
//        dataSeriesD.add(35d);
...
//        chartData.add(BarDataD);
    ...
    {
        chartLabels.add("累计用水量");
        chartLabels.add("剩余水量");
...
//        chart.setAnchorDataPoint(mAnchorSet);
        ...
        CustomLineData line1 = new CustomLineData("总配额",500d,Color.rgb(218, 198, 61),7);
