...
import com.zte.topsky.disaster.adapter.RiverListAdapter;
 ...
 * on 2016/12/2 16:06.
 */
public class RiverActivity extends BaseActivity implements AMap.OnMarkerClickListener,AMap.OnMapClickListener {

    @BindView(R.id.tv_title_text)
    TextView tvTitleText;
    @BindView(R.id.tv_river_list)
    TextView tvRiverList;
    @BindView(R.id.iv_river_list_indicator)
    ImageView ivRiverListIndicator;
    @BindView(R.id.ll_river_list)
    LinearLayout llRiverList;
    ...
    private RiverListAdapter listAdapter;
    ...
    private void initData() {
        mData = DisasterMapNet.getInitRiverDetailedData(getApplicationContext());
    }
    ...
    @OnClick(R.id.ll_river_list)
    public void onClick() {
        listAdapter = new RiverListAdapter(this,mData);
        dialog = DialogPlus.newDialog(RiverActivity.this)
